...
Automation Repository Explorer is a static-analysis application. It does not use LLMs,
OpenAI APIs, embeddings, vector databases, semantic search, or machine learning.
